...
const Circle = memo(({
  ...
  const handleTransformEnd = (e) => {
    ...
    if (selectedObjects.length > 1 && onMultiTransform) {
      ...
      console.log('🔍 CIRCLE MULTI-TRANSFORM DEBUG:', {
        wasResize,
        wasRotation,
      ...
      if (wasRotation) {
        ...
        console.log('🔍 CIRCLE ROTATION DATA (PRIORITIZED):', {
        ...
        console.log('🔍 CIRCLE RESIZE DATA:', {
          scaleX,
          scaleY,
          transformData
        });
      ...
      console.log('🔍 CIRCLE FINAL TRANSFORM DATA:', {
        transformData,
      ...
      if (Object.keys(transformData).length > 0) {
        console.log('🔍 CIRCLE CALLING onMultiTransform with:', {
